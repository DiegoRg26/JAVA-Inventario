...
public class ModeloTabla extends AbstractTableModel {
    ...
    private String[] nomColumnas = {"ID", "Producto", "Descripcion", "Precio", "Inventario"};
    private List<Producto> nproductos = new ArrayList<>();

    public ModeloTabla(List<Producto> pro) {
        this.nproductos = pro;
    }
    ...
    public Object getValueAt(int fila, int colum) {
        ...
        switch (colum) {
            ...
            case 1:
                ...
                break;
            case 2:
                resp = this.nproductos.get(fila).getDescripcion();
                break;
            case 3:
                resp = this.nproductos.get(fila).getPrecio();
                break;
            default:
                resp = this.nproductos.get(fila).getInventario();
        }
        return resp;
    }
    ...
    public Producto detalles(int fila) {
